...
SESSIONS_FILE = Path(".tasks/.sessions.yaml")
...
def format_phase_path(phase) -> str:
    ...
    return _join_path(".tasks", phase.path)


def _milestone_rel_path(tree, milestone) -> str:
    """Build milestone path relative to .tasks (without the prefix)."""
...
def format_milestone_path(tree, milestone) -> str:
    ...
    return _join_path(".tasks", _milestone_rel_path(tree, milestone))


def _epic_rel_path(tree, epic) -> str:
    """Build epic path relative to .tasks (without the prefix)."""
