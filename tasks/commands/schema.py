...
from ..helpers import CONTEXT_FILE, SESSIONS_FILE
...
def _build_schema_spec() -> dict:
    ...
    return {
        ...
        "files": [
            ...
            {
                "name": "Phase index",
                "path_pattern": ".tasks/<phase-path>/index.yaml",
                "format": "yaml",
                "fields": [
                    _field(
                        "milestones",
            ...
            },
            {
                ...
                "path_pattern": ".tasks/<phase-path>/<milestone-path>/index.yaml",
                "format": "yaml",
                "fields": [
                    _field("epics", "list[EpicEntry]", True, "Epics for this milestone."),
                    _field(
                        "stats",
                        "object",
                        False,
            ...
            {
                "name": "Epic index",
                "path_pattern": ".tasks/<phase-path>/<milestone-path>/<epic-path>/index.yaml",
                "format": "yaml",
                "fields": [
                    _field(
                        "tasks",
            ...
            {
                "name": "Task file",
                "path_pattern": ".tasks/<phase-path>/<milestone-path>/<epic-path>/T###-*.todo",
            ...
            {
                "name": "Context file",
                "path_pattern": ".tasks/.context.yaml",
                "format": "yaml",
                "fields": [
                    _field(
                        "mode",
            ...
            {
                "name": "Sessions file",
                "path_pattern": ".tasks/.sessions.yaml",
                "format": "yaml",
                "fields": [
                    _field(
                        "<agent_id>",
            ...
            {
                "name": "Config file",
                "path_pattern": ".tasks/config.yaml",
                "format": "yaml",
                "fields": [
                    _field(
                        "agent",
        ...
        "object_types": [
            {
                ...
                "fields": [
                    ...
                    _field("weeks", "integer", False, "Phase duration in weeks.", default=2),
                    _field(
                        "estimate_hours",
                        "number",
                        False,
            ...
            },
            {
                ...
                "fields": [
                    ...
                    _field("file", "string", False, "Task filename relative to epic dir."),
                    ...
                    _field("estimate_hours", "number", False, "Task estimate fallback."),
                    _field(
                        "complexity",
                        "string",
                        False,
            ...
            },
            {
                ...
                "fields": [
                    ...
                    _field("estimate_hours", "number", True, "Estimated effort in hours."),
                    _field(
                        "complexity",
                        "string",
                        True,
...
def _validate_schema_sync(spec: dict) -> list[str]:
    ...
    elif context_file["path_pattern"] != str(CONTEXT_FILE):
        errors.append(
            f"Context file path mismatch: expected {CONTEXT_FILE}, got {context_file['path_pattern']}."
        )

    sessions_file = _find_file_spec(spec, "Sessions file")
    if not sessions_file:
        errors.append("Missing file schema: Sessions file.")
    elif sessions_file["path_pattern"] != str(SESSIONS_FILE):
        errors.append(
            f"Sessions file path mismatch: expected {SESSIONS_FILE}, got {sessions_file['path_pattern']}."
        )
...
def _print_text_schema(spec: dict) -> None:
    ...
    console.print("\n[bold cyan].tasks File-Type Schema[/]")
...
def _print_compact_schema(spec: dict) -> None:
    ...
    console.print("\n[bold cyan].tasks File-Type Schema (Compact)[/]")
